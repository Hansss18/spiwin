...
<head>
	...
	<title>Input Data Pembeli | Spiwin</title>
          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					<form action="data.php?action=update2" method="post"> 
					<h1 class="h3 mb-3">Data Pembeli</h1>
						...
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title mb-0">Input Data Pembeli</h5>
								</div>
								<div class="card-body">
									<input type="text" class="form-control" name="kd" value="<?php echo $data_pembeli['kd_pbl']; ?>" placeholder="Kode Pembeli">
								</div>
								<div class="card-body">
									<input type="text" class="form-control" name="nm" value="<?php echo $data_pembeli['nm_pbl']; ?>" placeholder="Nama Pembeli">
								</div>
								<div class="card-body">
									<input type="text" class="form-control" name="no" value="<?php echo $data_pembeli['no_hp']; ?>" placeholder="No.Handphone">
								</div>
								<div class="card-body">
									<input type="text" class="form-control" name="al" value="<?php echo $data_pembeli['alamat']; ?>" placeholder="Alamat">
								</div>
								<div class="card-body">
