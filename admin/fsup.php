          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					<form action="data.php?action=add3" method="post"> 
					...
					<div class="row">
						<div class="col-12">
							<div class="card">
								...
								<div class="card-body">
									<input type="text" class="form-control" name="kd" placeholder="Kode Supplier">
								</div>
								<div class="card-body">
									<input type="text" class="form-control" name="nm" placeholder="Nama Supplier">
								</div>
								<div class="card-body">
									<input type="text" class="form-control" name="no" placeholder="No Telepon">
								</div>
								<div class="card-body">
