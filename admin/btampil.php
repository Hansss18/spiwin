...
<head>
	...
	<title>Tabel Barang | Spiwin</title>
...
<body>
          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					<h1 class="h3 mb-3">Tabel Data Barang</h1>
					<a class="btn btn-info" href="fbar.php">  <i class="align-middle me-2" data-feather="upload"></i> <span class="align-middle">Add</span></a>
					<br><br>
					<div class="row">
						<div class="col-12">
							<div class="card">
								...
								<table class="table table-hover my-0">
									<thead>
										<tr>
											...
											<th class="d-none d-xl-table-cell">Nama Supplier</th>
											<th>Qty</th>
  ...
  <td><a class ="btn btn-warning" href="ebar.php?id=<?php echo$x['kd_brg'];?>&aksi=edit">Edit</a>
  <a class="btn btn-danger" href="data.php?action=delete1&id=<?php echo$x['kd_brg'];?>&aksi=hapus">Hapus</a></td>  
										</tr>
										<?php
									}
									?>
