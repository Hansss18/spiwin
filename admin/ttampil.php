...
<body>
          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					<h1 class="h3 mb-3">Tabel Data Transaksi</h1>
					<a class="btn btn-info" href="ftran.php">  <i class="align-middle me-2" data-feather="upload"></i> <span class="align-middle">Add</span></a>
					<br><br>
					<div class="row">
						<div class="col-12">
							<div class="card">
  ...
  <td><a class ="btn btn-warning" href="etran.php?id=<?php echo$x['kd_tr'];?>&aksi=edit">Edit</a>
  <a class="btn btn-danger" href="data.php?action=delete5&id=<?php echo$x['kd_tr'];?>&aksi=hapus">Hapus</a>
  <a class="btn btn-info" href="bayar.php?id=<?php echo$x['kd_tr'];?>&aksi=bayar">Pembayaran</a></td>  
										</tr>
										<?php
									}
								}else{
