...
<body>
          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					<form action="data.php?action=add1" method="post"> 
					...
					<div class="row">
						<div class="col-12">
							<div class="card">
								...
								<div class="card-body">
									<input type="text" class="form-control" name="kd" placeholder="Kode Barang">
								</div>
								<div class="card-body">
									<input type="text" class="form-control" name="nm" placeholder="Nama Barang">
								</div>
								<div class="card-body">
  ...
  foreach ($db->tampil_data_supplier() as $y) {
    ...
    ?>
								...
								<div class="card-body">
									<input type="text" class="form-control" name="harb" placeholder="Harga Jual">
								</div>
								<div class="card-body">
