...
if (! is_null($kd_pembay)) {
  // code...
  $data_pem = $db->get_by_pem($kd_pembay);
} else {
          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					<form action="data.php?action=update4" method="post"> 
					<h1 class="h3 mb-3">Data Pembayaran</h1>
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title mb-0">Input Data Pembayaran</h5>
								</div>
								<div class="card-body">
									<input type="text" class="form-control" name="kt" value="<?php echo $data_pem['kd_pmb']; ?>" placeholder="Kode Pembayaran">
								</div>
								<div class="card-body">
									<input type="text" class="form-control" name="tb" value="<?php echo $data_pem['total']; ?>" placeholder="Total Bayar">
								</div>
								<div class="card-body">
									<select class="form-control" name="kp">
										 <option value="<?php echo $data_pem['kd_tr']; ?>"><?php echo $data_pem['kd_tr']; ?></option>
                        <?php
  foreach ($db->tampil_data_tran() as $y) {
      echo "<option value = ".$y['kd_tr'].">".$y['kd_tr']."</option>";
    }
    ?>
									</select>
								</div>
								<div class="card-header">
									<h5 class="card-title mb-0">Data Transaksi Tidak Ada?</h5>
									<br>	
									<a href="ftran.php" class="btn btn-warning">Tambah Disini</a>
								</div>
