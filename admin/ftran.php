          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					<form action="data.php?action=ad4" method="post"> 
					...
					<div class="row">
						<div class="col-12">
							<div class="card">
								...
								<div class="card-body">
									<input type="text" class="form-control" name="kt" placeholder="Kode Transaksi">
								</div>
								<div class="card-body">
    ...
    ?>
								...
								<div class="card-body">
									<select class="form-control" name="kp">
										 <option value="" disabled selected>Pembeli</option>
                        <?php
