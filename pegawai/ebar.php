...
<head>
	...
	<title>Input Data Barang | Spiwin</title>
          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					<form action="data.php?action=update1" method="post"> 
						...
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title mb-0">Input Data Barang</h5>
								</div>
								<div class="card-body">
									<input type="text" class="form-control" name="kd" value="<?php echo $data_barang['kd_brg']; ?>" placeholder="Kode Barang">
								</div>
								<div class="card-body">
									<input type="text" class="form-control" name="nm" value="<?php echo $data_barang['nm_brg']; ?>" placeholder="Nama Barang">
								</div>
								<div class="card-body">
									<select class="form-control" name="ns" >
										 <option value="<?php echo $data_barang['kd_sp']; ?>" ><?php echo $data_barang['kd_sp']; ?></option>
                        <?php
  foreach ($db->tampil_data_supplier() as $y) {
      echo "<option value = ".$y['kd_sp'].">".$y['nm_sp']."</option>";
    }
    ?>
									</select>
								</div>
								<div class="card-body">
									<input type="text" class="form-control" name="qty" value="<?php echo $data_barang['qty']; ?>" placeholder="Qty">
								</div>
								<div class="card-body">
									<input type="text" class="form-control" name="harga" value="<?php echo $data_barang['hrg']; ?>" placeholder="Harga">
								</div>
								<div class="card-body">
