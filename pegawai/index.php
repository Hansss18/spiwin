			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="row">
									...
									<div class="col-sm-6">
										<div class="card">
											<div class="card-body">
												...
												<h1 class="mt-1 mb-3"><?php $db->hitung_tran() ;  ?></h1>
											</div>
										</div>
										<div class="card">
											<div class="card-body">
												...
												<h1 class="mt-1 mb-3"><?php $db->hitung_pemn() ;  ?></h1>
									...
									<div class="col-sm-6">
										<div class="card">
											<div class="card-body">
												...
												<h1 class="mt-1 mb-3"><?php $db->hitung_pem() ;  ?></h1>
											</div>
										</div>
										<div class="card">
											<div class="card-body">
												...
												<h1 class="mt-1 mb-3"><?php $db->hitung_barang() ;  ?></h1>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="col-3 col-md-6 col-xxl-7 d-flex order-1 order-xxl-1">
