	...
	<div class="wrapper">
        ...
        <li class="sidebar-header">
            ...
            <i class="align-middle me-2" data-feather="folder"></i> <span class="align-middle">Data Supplier</span>
             ...
             <i class="align-middle me-2" data-feather="dollar-sign"></i> <span class="align-middle">Input Data Transaksi</span>
            </a>
					</li>
          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					<h1 class="h3 mb-3">Tabel Data Pembayaran</h1>
					<a class="btn btn-info" href="fbay.php">  <i class="align-middle me-2" data-feather="upload"></i> <span class="align-middle">Add</span></a>
					<a class="btn btn-warning" href="cetak.php">  <i class="align-middle me-2" data-feather="print"></i> <span class="align-middle">Print</span></a>
					<br><br>
					<div class="row">
						<div class="col-12">
							<div class="card">
								...
								<table class="table table-hover my-0">
									<thead>
										<tr>
											...
											<th class="d-none d-xl-table-cell">Tanggal Pembayaran</th>
											...
											<th class="d-none d-xl-table-cell">Jumlah Pembayaran</th>
											<th class="d-none d-md-table-cell">Opsi</th>
										</tr>
									</thead>
									<tbody>
										 <?php
										 if (! empty($db->tampil_data_pem())) {
                        ...
                        foreach ($db->tampil_data_pem() as $x) {
										...
										<tr>
											<td><?php echo $x['kd_pmb'] ?></td>
  											...
  											<td><?php echo $x['kd_tr']; ?></td>
  											<td><?php echo $x['nm_brg']; ?></td>
  											<td>Rp.<?php echo number_format($x['hrg']); ?></td>
  											<td><?php echo $x['nm_pbl']; ?></td>
  											<td>Rp.<?php echo number_format($x['total']); ?></td>
  <td><a class ="btn btn-warning" href="ebay.php?id=<?php echo$x['kd_pmb'];?>&aksi=edit">Edit</a>
  	<a class ="btn btn-info" href="struk.php?id=<?php echo$x['kd_pmb'];?>&aksi=struk">Struk</a>
  <a class="btn btn-danger" href="data.php?action=delete4&id=<?php echo$x['kd_pmb'];?>&aksi=hapus">Hapus</a></td>  
										</tr>
										<?php
									}
								}else{
