          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					<form action="data.php?action=add2" method="post"> 
					...
					<div class="row">
						<div class="col-12">
							<div class="card">
								...
								<div class="card-body">
									<input type="text" class="form-control" name="kd" placeholder="Kode Pembeli">
								</div>
								<div class="card-body">
									<input type="text" class="form-control" name="nm" placeholder="Nama Pembeli">
								</div>
								<div class="card-body">
									<input type="text" class="form-control" name="no" placeholder="No.Handphone">
								</div>
								<div class="card-body">
									<input type="text" class="form-control" name="al" placeholder="Alamat">
								</div>
								<div class="card-body">
