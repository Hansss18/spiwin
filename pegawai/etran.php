          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					<form action="data.php?action=update5" method="post"> 
					<h1 class="h3 mb-3">Data Transaksi</h1>
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title mb-0">Input Data Transaksi</h5>
								</div>
								<div class="card-body">
									<input type="text" class="form-control" name="kt" value="<?php echo $data_tran['kd_tr']; ?>" placeholder="Kode Transaksi">
								</div>
								<div class="card-body">
									<select class="form-control" name="kb">
										 <option value="<?php echo $data_tran['kd_brg']; ?>" ><?php echo $data_tran['kd_brg']; ?></option>
                        <?php
  foreach ($db->tampil_data_barang() as $y) {
      echo "<option value = ".$y['kd_brg'].">".$y['nm_brg']."</option>";
    }
    ?>
									</select>
								</div>
								<div class="card-body">
									<select class="form-control" name="kp">
										 <option value="<?php echo $data_tran['kd_pbl']; ?>"><?php echo $data_tran['kd_pbl']; ?></option>
                        <?php
  foreach ($db->tampil_data_pembeli() as $y) {
      echo "<option value = ".$y['kd_pbl'].">".$y['nm_pbl']."</option>";
    }
    ?>
									</select>
								</div>
								<div class="card-header">
									<h5 class="card-title mb-0">Data Pembeli Tidak Ada?</h5>
									<br>	
									<a href="fpem.php" class="btn btn-warning">Tambah Disini</a>
								</div>
