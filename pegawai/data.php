...
$action = $_GET['action'];
if ($action == "add1") {
	$koneksi->tambah_data_barang($_POST['kd'],$_POST['nm'],$_POST['ns'],$_POST['qty'],$_POST['harga']);
	...
	$dt = new DateTime("now", new DateTimeZone($tz));
	$timestamp = $dt->format('Y-m-d G:i:s');
	$koneksi->tambah_data_pem($_POST['kt'],$timestamp,$_POST['tb'],$_POST['kp']);
	...
	$koneksi->update_data_barang($_POST['kd'],$_POST['nm'],$_POST['ns'],$_POST['qty'],$_POST['harga']);
	header('location:btampil.php');
