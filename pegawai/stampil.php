...
<head>
	...
	<title>Tabel Suppliers | Spiwin</title>
          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					<h1 class="h3 mb-3">Tabel Data Suppliers</h1>
					<a class="btn btn-info" href="fsup.php">  <i class="align-middle me-2" data-feather="upload"></i> <span class="align-middle">Add</span></a>
					<br><br>
					<div class="row">
						<div class="col-12">
							<div class="card">
								...
								<table class="table table-hover my-0">
									<thead>
										<tr>
											...
											<th class="d-none d-xl-table-cell">Nama Suppliers</th>
									...
									<tbody>
										 <?php
										 if (! empty($db->tampil_data_supplier())) {
										 	
										 
                        foreach ($db->tampil_data_supplier() as $x) {
  											?>
										<tr>
											<td><?php echo $x['kd_sp'] ?></td>
  											<td><?php echo $x['nm_sp']; ?></td>
  											<td><?php echo $x['no_tlp']; ?></td>
  											<td><?php echo $x['alamat']; ?></td>
  <td><a class ="btn btn-warning" href="esup.php?id=<?php echo$x['kd_sp'];?>&aksi=edit">Edit</a>
  <a class="btn btn-danger" href="data.php?action=delete3&id=<?php echo$x['kd_sp'];?>&aksi=hapus">Hapus</a></td>  
										</tr>
										<?php
									}
								}else{
